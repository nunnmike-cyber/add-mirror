    ...
    <div style={{ minHeight: '100vh', background: COLORS.cream }}>
      <div style={{ maxWidth: 660, margin: '0 auto', padding: '60px 24px 80px' }}>
        ...
        <div style={{ fontFamily: "'Lora', Georgia, serif", fontSize: 16, lineHeight: 1.8, color: COLORS.inkLight }}>
          ...
          <p>For a one-time payment of £3.99, you can unlock a full report including your ADHD archetype, a personal three-word profile, a strengths reframe, anxiety and mood screening (GAD-7/PHQ-9), a downloadable clinician summary, scripts for talking to your doctor, and workplace rights information — adapted to your region (UK, US, or elsewhere). This is a single one-time purchase, not a subscription — you will not be charged again. Access to your report is tied to the browser you purchased it in; if you clear your browser data or switch devices you may lose access, so we recommend downloading a PDF copy for your records once you've unlocked it.</p>
          <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: 22, color: COLORS.ink, margin: '32px 0 12px' }}>Not legal advice</h2>
          <p>Information about workplace rights, reasonable adjustments or accommodations, and healthcare access routes (including region-specific information such as Right to Choose or ADA accommodations) is provided for general informational purposes only and does not constitute legal advice. Employment law, disability rights, and healthcare systems vary by country and change over time. Please consult a qualified professional for guidance specific to your situation and location.</p>
